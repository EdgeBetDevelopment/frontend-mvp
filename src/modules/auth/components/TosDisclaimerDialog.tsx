        ...
        >
          ...
          <ScrollArea className="max-h-[260px] rounded-md border border-border bg-muted/30 p-4 text-sm leading-relaxed text-muted-foreground">
            <p className="mb-3">
              ...
              entertainment purposes only. We do not accept, place, or
              facilitate wagers of any kind.
            </p>
            <p className="mb-3">
              ...
              projections, and analysis reflect probabilistic outcomes — they
              are not guarantees.
            </p>
            <p className="mb-3">
              ...
              platform. Bet responsibly. If you or someone you know has a
