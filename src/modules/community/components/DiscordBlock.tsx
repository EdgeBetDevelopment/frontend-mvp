...
export const DiscordBlock = () => {
  return (
    <div
      ...
      className="rounded-4xl relative flex w-full flex-col items-center gap-9 overflow-hidden bg-[#E9E9E90D] px-8 py-6 md:px-14 md:py-12"
    >
      <div
      ...
      <div className="bg-primary-brand/30 absolute left-1/2 top-0 -z-10 h-full w-1/3 -translate-x-1/2 rounded-full blur-[300px]" />
